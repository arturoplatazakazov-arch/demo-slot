"""Seed data for the "gold-of-baku" game (front/gold-of-baku.html).

Fifth slot in the project's 3x3 classic family (after lucky-miami-3,
miami-fruits-3, country-gold-3 and ice-spin-deluxe) and the same deliberately
bare shape: LINE PAY AND NOTHING ELSE. No wild, no scatter, no free spins, no
...
New here is the dress (azerbaijani night: Baku skyline, carpet floor, a gold
ornament frame) and the symbol count: SEVEN symbols, the shortest ladder in the
family, because the delivered art has seven — tea glasses and pomegranate join
the fruit ladder, cherry/plum/lemon/star do not exist.
...
front/js/gold-of-baku/slot.js (each code == its PNG file name in
front/img/gold-of-baku/symbols/) — do not rename them.
"""
...
GAME_CODE = "gold-of-baku"
GAME_NAME = "Gold of Baku"
...
CATALOG_COVER_PATH = "img/gold-of-baku/img/cover.jpg"
CATALOG_PLAY_URL = "gold-of-baku.html"
