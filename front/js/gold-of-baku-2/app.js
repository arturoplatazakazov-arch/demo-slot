// Gold of Baku 2 — нижний бар и оркестрация спина. Скопировано с
// ../country-gold-3/app.js: один путь — нажали спин, дождались ответа, уронили
...
// пороги подобраны под здешнюю выплатную лестницу (апельсин даёт 1.4x, чай —
// 10.4x, колокольчики 30.4x, BAR 170.4x, семёрка 900x): bigWin начинается с
// чая, megaWin — это BAR, epicWin — семёрка. Ставить их реже нельзя, иначе на
// семи символах попап не увидит почти никто.
const POPUP_TIER_BY_RATIO = [[500, 'epicWin'], [100, 'megaWin'], [10, 'bigWin']];
