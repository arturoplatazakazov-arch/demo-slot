// Gold of Baku 2 — central sound manager, те же механики, что у остальных игр
...
const SOUND_FILES = {
  smallWin: EAST + 'WIN_Small.wav',
  bigWin: EAST + 'WIN_Big.wav',
  megaWin: EAST + 'WIN_Mega.wav',
  epicWin: EAST + 'WIN_Epic.wav',
