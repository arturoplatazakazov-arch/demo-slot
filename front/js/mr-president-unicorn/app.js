// Mr. President Unicorn — bottom UI bar + spin orchestration, adapted from
// ../wild-western-story/app.js. Session bootstraps on load; every Spin/Buy
// click is a real request.
const GAME_ID = 'mr-president-unicorn';
