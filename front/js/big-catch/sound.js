// Big Catch — central sound manager, copied from ../western-treasure/sound.js.
// Своего пака у рыбацкой темы нет: SFX выигрышей одолжены у
// wild-western-story (это чистые «звон/фанфара», без вестерн-окраски), фоновая
// музыка выключена (MUSIC_FILES пустой) до тех пор, пока не приедут свои
// BG_Base/BG_Bonus — ровно как в uniqorn-scandal.
//
// Assets split two ways (see front/sound/README.md): repeating SFX shared by
// every game live in sound/common/; win tiers and the wild-scale SFX come
// from the borrowed pack.
