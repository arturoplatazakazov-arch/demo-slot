// Ice Spin Deluxe — нижний бар и оркестрация спина. Адаптировано с
...
// пороги подобраны под здешнюю выплатную лестницу (вишня даёт 1.6x, семёрка —
// 1300x), так что bigWin начинается с винограда, mega — с колокольчиков,
// epic — со звёзд.
