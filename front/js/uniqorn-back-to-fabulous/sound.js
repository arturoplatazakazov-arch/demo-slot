// Uniqorn Back to Fabulous — central sound manager, копия neon-reels/sound.js
// (эта игра клонирует его механику): перекрывающиеся one-shot SFX + зацикленная
// музыка, разблокируемая первым жестом пользователя. Ассеты делятся надвое (см.
// front/sound/README.md): повторяющиеся SFX общие для всех игр и лежат в
// sound/common/.
// TODO: собственных звуков у темы пока нет — временно играем neon-reels'овские
// (тот же приём, что в mr-president-unicorn/sound.js). Звука приземления
// множителя нет ни у кого, этот путь 404-ит безвредно, пока файл не приедет.
