// Miami Fruits 3 — central sound manager, те же механики, что у остальных игр
...
//
// Собственного звукового пака у темы пока нет, поэтому тиры выигрыша играем
// чужие — из neon-reels. UI и барабаны — общие. Никаких звуков бонуса: бонуса
// в игре нет.
...
// Фоновой музыки в игре нет по решению продукта — играют только эффекты.
// Карта оставлена пустой, а не выпилена вместе с playMusic: весь музыкальный
// тракт ниже (разблокировка первым жестом, пауза по mute) общий для всех игр
// проекта, и когда для темы приедет свой трек, его хватит вписать одной
// строкой сюда. С пустой картой playMusic — тихий no-op.
const MUSIC_FILES = {};
