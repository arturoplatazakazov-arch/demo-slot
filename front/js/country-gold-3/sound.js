// Country Gold 3 — central sound manager, те же механики, что у остальных игр
...
// фоновая музыка — из вестерн-пака wild-western-story (единственная кантри-тема
// в проекте), UI и барабаны — общие.
const COMMON = 'sound/common/';
const WEST = 'sound/wild-western-story/';

const SOUND_FILES = {
  smallWin: WEST + 'WIN_Small.mp3',
  bigWin: WEST + 'WIN_Big.mp3',
  megaWin: WEST + 'WIN_Mega.mp3',
  epicWin: WEST + 'WIN_Epic.mp3',
