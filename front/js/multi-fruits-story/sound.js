// Multi Fruits Story — central sound manager, same mechanics as the other
...
const GAME = 'sound/multi-fruits-story/';
...
// Music tracks buffer only after window 'load' so they don't compete with
// the game art; by the first gesture the track is (mostly) buffered.
const musicCache = {};
